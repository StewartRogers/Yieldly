---
name: test-engineer
description: Creates, improves, and reviews automated tests. Use proactively when adding features, fixing bugs, refactoring code, or increasing test coverage.
